...
// Check if the user is already logged in, and if so, redirect to the admin page
       ...
       <div class="card-body">
        <form action="" method="post">
         <div class="mb-3">
          ...
          <input value="<?= $username ?>" name="username" type="text" class="form-control" id="username" placeholder="Enter your username">
         </div>
         <div class="mb-3">
