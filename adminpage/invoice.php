...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
 ...
 <div class="px-4 my-4 mb-2"> <input type="text" id="datepicker" class="form-control datepicker w-auto" placeholder="Please select date"></div>
 <div id="bookings" class="container-fluid py-4">
